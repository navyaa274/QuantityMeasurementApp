...
public class Quantity <U extends IMeasurable> {
    ...
    public double convertTo(U targetUnit) {
        ...
        if (this.unit instanceof TemperatureUnit temp1 &&
                targetUnit instanceof TemperatureUnit temp2){
            return temp1.convertTo(value, temp2);
        }
    ...
    public Quantity<U> add(Quantity<U> other) {
        ...
        double result = performArithmetic(other, ArithmeticOperation.ADD);
    ...
    public Quantity<U> subtract(Quantity<U> other) {
        ...
        double result = performArithmetic(other, ArithmeticOperation.SUBTRACT);
